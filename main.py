...
This demo was modified to kill itself when a keyboard is attached for
Maker Faire demos.
...
def check_for_keyboard(dt):
    if os.path.exists("/dev/input/by-path/"):
        exit()
...
class PicturesApp(App):
    ...
    def build(self):
        ...
        Clock.schedule_interval(check_for_keyboard, 0.5)
